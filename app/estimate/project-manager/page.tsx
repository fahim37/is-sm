  ...
  return (
    <div className="p-4">
      <div className="mb-6 rounded-md bg-black p-4 text-white">
        <h1 className="text-center text-2xl font-bold">Project Manager Home Page</h1>
      </div>
      ...
      <div className="mb-4 bg-black p-4 text-center text-white">
        <div className="flex justify-between">
          ...
          <div className="w-1/3 text-lg font-semibold">Project Dashboard</div>
          <div className="w-1/3">
            <Button variant="outline" className="w-full bg-white text-black">
              Employee Name
            </Button>
      ...
      <div className="mb-8 grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <div>
          ...
          <div className="border border-gray-200">
            <table className="w-full border-collapse">
              <tbody>
                <tr>
                  <td className="border border-gray-300 p-3 text-center font-medium">Action Tab</td>
                </tr>
                <tr>
        ...
        {/* Right Column - Knowledge Bank And Resources */}
        <div>
          <div className="mb-4 bg-black p-4 text-center text-white">
        ...
        <div className="grid grid-cols-1 gap-4">
          ...
          <div className="grid grid-cols-2 gap-0">
            <div className="border border-gray-300 p-3">
              ...
              <div className="border-b border-gray-300 p-2">Company News Flash</div>
              <div className="p-2">Safety Training Quiz and Modules</div>
            </div>
            <div className="border border-gray-300 p-3">
